...
void Info::GetCopyright(String* text)
{
	assert(text);
	...
	*text =
		...
		_T("Jean-loup Gailly and Mark Adler 1995-2024\n")
...
void Info::GetLicense(String* text)
{
	assert(text);
	...
	*text =
		...
		_T("\n")
		_T("The project uses \"ZLIB DATA COMPRESSION LIBRARY\" V1.3.1\n")
		_T("(C) 1995-2024 Jean-loup Gailly and Mark Adler\n")
		_T("\n")
		_T("The project uses the md5 algorithms from the \"XYSSL Library\" V0.8\n")
		_T("Copyright (C) 2006-2007  Christophe Devine\n")
		_T("\n")
		_T("The project uses the xsd-runtime library (C) 2005-2023 Code Synthesis\n")
...
void Info::GetAbout(String* text)
{
	assert(text);
...
void Info::GetVersion(String* text)
{
	assert(text);
