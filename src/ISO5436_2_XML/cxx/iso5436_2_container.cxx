...
bool ISO5436_2Container::VerifyChecksum(const std::filesystem::path& filePath, const UnsignedBytePtr checksum, size_t size) const
{
...
bool ISO5436_2Container::VerifyChecksum(const std::filesystem::path& filePath, std::array<UnsignedByte, 16>& checksum) const
{
...
bool ISO5436_2Container::ReadMd5FromFile(const std::filesystem::path& fileName, std::array<UnsignedByte, 16>& checksum) const
{
#ifdef _UNICODE
