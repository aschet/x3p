...
namespace OpenGPS
{
	...
	public:
		...
		virtual ~PointVectorWriterContext() = default;
		 ...
		 */
		virtual void Write(OGPS_Int16 value) = 0;
		 ...
		 * @param value Contains the point value on success.
		 */
		virtual void Write(OGPS_Int32 value) = 0;
		 ...
		 * @param value Contains the point value on success.
		 */
		virtual void Write(OGPS_Float value) = 0;
		 ...
		 * @param value Contains the point value on success.
		 */
		virtual void Write(OGPS_Double value) = 0;
