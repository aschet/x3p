...
namespace OpenGPS
{
	...
	public:
		...
		virtual ~PointVectorReaderContext() = default;
		 ...
		 */
		virtual void Read(OGPS_Int16& value) = 0;
		 ...
		 * @param value Contains the point value on success.
		 */
		virtual void Read(OGPS_Int32& value) = 0;
		 ...
		 * @param value Contains the point value on success.
		 */
		virtual void Read(OGPS_Float& value) = 0;
		 ...
		 * @param value Contains the point value on success.
		 */
		virtual void Read(OGPS_Double& value) = 0;
