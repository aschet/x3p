...
inline void BinaryLSBPointVectorWriterContext::WriteT(T value)
{
   CheckStreamAndThrowException();

   static_assert(sizeof(value) == TSize, "value has incorrect byte size");
   GetStream()->write(reinterpret_cast<const char*>(&value), TSize);

   CheckIsGoodAndThrowException();
}

void BinaryLSBPointVectorWriterContext::Write(OGPS_Int16 value)
{
   WriteT<OGPS_Int16, _OPENGPS_BINFORMAT_INT16_SIZE>(value);
}

void BinaryLSBPointVectorWriterContext::Write(OGPS_Int32 value)
{
   WriteT<OGPS_Int32, _OPENGPS_BINFORMAT_INT32_SIZE>(value);
}

void BinaryLSBPointVectorWriterContext::Write(OGPS_Float value)
{
   WriteT<OGPS_Float, _OPENGPS_BINFORMAT_FLOAT_SIZE>(value);
}

void BinaryLSBPointVectorWriterContext::Write(OGPS_Double value)
{
