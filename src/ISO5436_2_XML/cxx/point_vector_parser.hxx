...
namespace OpenGPS
{
	...
	public:
		 ...
		 */
		void SetX(std::unique_ptr<DataPointParser> value);
		 ...
		 * @see PointVectorParser::CreateDataPointParser
		 */
		void SetY(std::unique_ptr<DataPointParser> value);
		 ...
		 * @see PointVectorParser::CreateDataPointParser
		 */
		void SetZ(std::unique_ptr<DataPointParser> value);
		 ...
		 */
		void Read(PointVectorReaderContext& context, PointVectorBase& value);
		 ...
		 */
		void Write(PointVectorWriterContext& context, const PointVectorBase& value);
		 ...
		 * @returns Returns the instance of the point parser or nullptr on failure.
		 */
		std::unique_ptr<DataPointParser> CreateDataPointParser(OGPS_DataPointType dataType) const;

	private:
		/*! Instance of the point parser of the X component. */
		std::unique_ptr<DataPointParser> m_X;

		/*! Instance of the point parser of the Y component. */
		std::unique_ptr<DataPointParser> m_Y;

		/*! Instance of the point parser of the Z component. */
		std::unique_ptr<DataPointParser> m_Z;
	};
}
