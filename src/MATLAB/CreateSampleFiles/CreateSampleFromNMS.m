...
z2 = repmat(z,[1,1,2]);
z2(:,:,2) = z2(:,:,2) + 100e-6;
meta.Comment = 'Confocal Measurement of star structure on a 1 Euro coin. Objective 20x0.6. Second layer created by z-shift of 100�m.';
...
meta.Comment = ['Confocal Measurement of star structure on a 1 Euro coin.',...
  ...
  'Second layer created by z-shift of 100 µm.'];
