...
extern "C" {
	...
	_OPENGPS_EXPORT OGPS_ISO5436_2Handle ogps_OpenISO5436_2(
		...
		const OGPS_Character* temp = NULL);
	 ...
	 */
	_OPENGPS_EXPORT void ogps_WriteISO5436_2(const OGPS_ISO5436_2Handle handle, int compressionLevel = -1);
	 ...
	 */
	_OPENGPS_EXPORT bool ogps_GetVendorSpecific(const OGPS_ISO5436_2Handle handle, const OGPS_Character* vendorURI, const OGPS_Character* fileName, const OGPS_Character* targetPath);
	 ...
	 */
	_OPENGPS_EXPORT bool ogps_IsMatrixCoordValid(
		const OGPS_ISO5436_2Handle handle,
		size_t u,
		size_t v,
		size_t w);
	...
	*/
	_OPENGPS_EXPORT bool ogps_IsMatrix(const OGPS_ISO5436_2Handle handle);
	...
	* processed correctly, otherwise future behavior of your program is undefined!
	*/
	_OPENGPS_EXPORT size_t ogps_GetListDimension(const OGPS_ISO5436_2Handle handle);
