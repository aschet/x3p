...
extern "C" {
	...
	* and true is returned. Otherwise nothing will happen and false is returned.
	 ...
	 */
	_OPENGPS_EXPORT void ogps_FreePointVector(OGPS_PointVectorPtr* vector);
	 ...
	 * @param vector Operate on this point vector instance.
	 */
	_OPENGPS_EXPORT OGPS_DataPointPtr ogps_GetX(OGPS_PointVectorPtr vector);
	 ...
	 * @param vector Operate on this point vector instance.
	 */
	_OPENGPS_EXPORT OGPS_DataPointPtr ogps_GetY(OGPS_PointVectorPtr vector);
	 ...
	 * @param vector Operate on this point vector instance.
	 */
	_OPENGPS_EXPORT OGPS_DataPointPtr ogps_GetZ(OGPS_PointVectorPtr vector);
	 ...
	 */
	_OPENGPS_EXPORT bool ogps_IsValidPoint(const OGPS_PointVectorPtr vector);
