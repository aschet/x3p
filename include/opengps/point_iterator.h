...
extern "C" {
	 ...
	 */
	_OPENGPS_EXPORT bool ogps_HasNextPoint(const OGPS_PointIteratorPtr iterator);
	 ...
	 * @returns Returns true if there is at least one more point available to iterate, false otherwise.
	 */
	_OPENGPS_EXPORT bool ogps_HasPrevPoint(const OGPS_PointIteratorPtr iterator);
	 ...
	 */
	_OPENGPS_EXPORT bool ogps_MoveNextPoint(OGPS_PointIteratorPtr iterator);
	 ...
	 * @returns Returns true on success, false otherwise.
	 */
	_OPENGPS_EXPORT bool ogps_MovePrevPoint(OGPS_PointIteratorPtr iterator);
	 ...
	 * @param iterator Operate on this iterator handle.
	 */
	_OPENGPS_EXPORT void ogps_ResetNextPointIterator(OGPS_PointIteratorPtr iterator);
	 ...
	 * @param iterator Operate on this iterator handle.
	 */
	_OPENGPS_EXPORT void ogps_ResetPrevPointIterator(OGPS_PointIteratorPtr iterator);
	...
	*/
	 ...
	 * @returns Returns true on success, false otherwise.
	 */
	_OPENGPS_EXPORT bool ogps_GetMatrixPosition(
		const OGPS_PointIteratorPtr iterator,
		size_t* u,
		size_t* v,
		size_t* w);
	 ...
	 * @returns Returns true on success, false otherwise.
	 */
	_OPENGPS_EXPORT bool ogps_GetListPosition(
		const OGPS_PointIteratorPtr iterator,
		size_t* index);
	 ...
	 * @param iterator Operate on this iterator handle.
	 */
	_OPENGPS_EXPORT void ogps_FreePointIterator(OGPS_PointIteratorPtr* iterator);
